...
def hybrid(data=100, epochs=1,test_time=False):
...
if __name__ == '__main__':
    ...
    for n_samples, epochs, lr in zip(sweep_samples, epochs_arr, lr_arr):
        ...
        ## Hybrid ##
        print("\n######## \nHybrid: start\n########\n")
        val_error = hybrid(data=n_samples, epochs=int(epochs),test_time=False)
    ...
    print("\n######## \nTest Hybrid: start\n########\n")
    test_error = hybrid(epochs=1,test_time=True)
